...
// -ldflags "-X github.com/tetrafolium/sourcegraph-cloned/internal/version.version=1.2.3"
//
...
// -ldflags "-X github.com/tetrafolium/sourcegraph-cloned/internal/version.timestamp=$UNIX_SECONDS"
